package com.dean.android.famework.convenient.application;
...
import com.dean.android.famework.convenient.util.SetUtil;
...
public abstract class ConvenientApplication extends Application {
    ...
    private void init() {
        ...
        new Thread(() -> {
            ...
            versionUpdate.checkUpdate(hasVersionUpdate -> {
                /** 设置app初始化完成 **/
                appInitFinish();
            });
        }).start();
